...
export class Manager{
    ...
    showStartPage(){
        ...
        this.ctx.fillText("Paper Cutter", this.rows[1].cx, this.rows[1].cy);
        // description
        this.ctx.fillStyle = "#ffdda1";
        this.ctx.font = `italic ${this.canvas.width/45}px Candara`;
        this.ctx.fillText("cut the paper into pieces!", this.rows[2].cx, this.rows[2].cy);
        // control keys
        this.ctx.fillStyle = "#ffdda1";
        this.ctx.font = `italic ${this.canvas.width/45}px Candara`;
        this.ctx.fillText("control keys : Arrow up/down/right/left & space", this.rows[6].cx, this.rows[6].cy);
        // menu
    ...
    showClearPage(){
        ...
        // message
        this.ctx.font = `${this.canvas.width/25}px Candara`;
        this.ctx.fillText(`You cleared all the ${this.game.menuMap[this.game.menuIndex].name} stages`, this.rows[4].cx, this.rows[4].cy);
        // back to Start
        this.ctx.font = `italic ${this.canvas.width/30}px Candara`;
        this.ctx.fillText("Click here to Restart", this.rows[6].cx, this.rows[6].cy);
        this.ctx.restore();
